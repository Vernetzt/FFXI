...
subWeapon = M('Daybreak','Tauret', 'Ammurapi shield', 'Machaera +2', 'Naegling','Qutrub Knife')
TpBonus = "Machaera +2"
...
function get_sets()
    ...
    sets.me["Sanguine Blade"] = set_combine(sets.me["Seraph Blade"],{

    })
    sets.me["Red Lotus Blade"] = set_combine(sets.me["Seraph Blade"],{
    ...
    -- DW Sets
    sets.midcast.nuking.normal.DW = set_combine(sets.midcast.nuking.normal, {

    })
    sets.midcast.nuking.acc.DW = set_combine(sets.midcast.nuking.acc, {
    ...
    sets.midcast.MB.normal.DW = set_combine(sets.midcast.MB.normal, {

    })
    sets.midcast.MB.acc.DW = set_combine(sets.midcast.MB.acc, {
    ...
    sets.midcast.Enfeebling.macc.bow = set_combine(sets.midcast.Enfeebling.macc, {
